          ...
          <div class="row">
              <div class="col-lg-6 offset-lg-3">
                  <div class="section-heading wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                      ...
                      <h3>{{ __('contact.subtitle') }}
                          <em>{{ __('contact.now') }}</em></h3>
                      ...
                      <div class="row">
                          <div class="col-lg-12">
                              <div class="contact-dec">
                                  <img src="{{ asset('assets/images/contact-dec-v3.png') }}"
                                      alt="">
                              </div>
                          </div>
                          <div class="col-lg-12">
                              <div class="fill-form">
                                  <div class="row">
                                      ...
                                      <div class="col-lg-4">
                                          <div class="info-post">
                                              <div class="icon">
                                                  <img src="{{ asset('assets/images/location-icon.png') }}"
                                                      alt="">
                                      ...
                                      <div class="col-lg-12">
                                          <fieldset>
                                              <button type="submit"
                                                  class="main-button">{{ __('contact.send_message') }}</button>
                                          </fieldset>
                                      </div>
                  </form>
              </div>
